...
class MyConfig
{
  ...
  public MyConfig()
  {
    ...
    this.K8SVersion = cfg.Get("azure:k8sVersion") ?? "1.19.11";
    this.NodeCount = cfg.GetInt32("azure:nodeCount") ?? 2;
    this.NodeSize = cfg.Get("azure:nodeSize") ?? "Standard_D2_v2";
    ...
    this.Location = cfg.Get("azurre:location") ?? "westeurope";
  }
